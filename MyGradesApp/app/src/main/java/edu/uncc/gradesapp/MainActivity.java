...
//remember to enable "email/password" authentication under "Build" in Firestore
//make sure you start the Firestore Database in "test mode". "Rule" section should have:
//rules_version = '2';
//
...
//    // your rules
//    match /{document=**} {
//      allow read, write: if request.time < timestamp.date(2024, 4, 30);
//    }
//  }
//}
