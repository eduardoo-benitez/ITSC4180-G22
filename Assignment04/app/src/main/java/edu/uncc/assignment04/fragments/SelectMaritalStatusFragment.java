...
public class SelectMaritalStatusFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("SelectMaritalStatusFragment");
        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (maritalStatus == null) {
                    Toast.makeText(getActivity(), "Select a marital status", Toast.LENGTH_SHORT).show();
                }
                else {
                    mListener.maritalStatusUpdate(maritalStatus);
                }
            }
        });
        ...
        binding.buttonCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.cancelMaritalStatusUpdate();
            }
        });
    }
    SelectMaritalStatusFragment.SelectMaritalStatusListener mListener;
